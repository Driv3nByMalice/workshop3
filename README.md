...
Для данной работы я выбрал меч, дробовик, пулемёт, РПГ-7 и алебарду

Ссылка на заполненую по шаблону гугл таблицу
https://docs.google.com/spreadsheets/d/1CfHpCCUijVS53eUXYh1FDyfVj1f4lRKu/edit?gid=958836135#gid=958836135
...
Научился балансировать оружие в играх (на примере игры Save RTF). Практика была несложной, единственный напряжный момент - визуализация попадания по цели.
